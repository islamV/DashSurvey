...
// use Modules\Complaints\App\Models\Question;

class HotelComplaints extends Chart{
                    ...
                    'data'=>[
                            ...
                            'datasets'=>[
                                [
                                    ...
                                    'data'=>[
                                        Complaint::where('status' , 'positive')->where('type' , 'hotels')->count(),
                                        Complaint::where('status' , 'negative')->where('type' , 'hotels')->count(),
