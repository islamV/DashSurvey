...
class Hotels extends Value{
     ...
     */
      public function calc(){
        return
        $this->count( Survey::class ,function($model){
  ...
  ->at('created_at') // optional
     ...
     ->href(dash('resource/HotelsSurvey'))
      ->icon('<i class="fa-regular fa-clipboard"></i>') // icon by fontawesome or other | optional
     ->title(__('survey.hotel')) // optional
    //    ->subTitle('Your subTitle') // optional
    ->textBody('Text In Body') // optional
    ->prefix('<i class="fa-regular fa-clipboard"></i> ') // add prefix before number or icon
