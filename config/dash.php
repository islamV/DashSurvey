...
return [
	 ...
	 * @param string
	 */
	'DASH_ACCESS_KEY' => env('DASH_ACCESS_KEY', 'M2tjRjJCbEswdVIxbVdKZVhVc3Rpc2xhbWFiZGVsa2FyaW03QGdtYWlsLmNvbQ=='),

	/**
	 * DASHBOARD ICON you can put url or leave it empty
	 * @param string
	 */
    'DASHBOARD_ICON' => env('APP_URL').'/dashboard/assets/img/dash/PNG/icon white.png',
