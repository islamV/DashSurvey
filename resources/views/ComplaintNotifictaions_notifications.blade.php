...
<div class="list-group-item  align-items-center border-bottom">
    <div class="d-flex">
        ...
        <div class="mt-1">
            <a  href="{{ route('show_complaint',['complain_id'=>$list->id]) }}" class="font-weight-semibold fs-16">{{ $list->survey->guest->name}} <span class="text-muted font-weight-normal">{{ __('survey.Newcomplain') }}</span></a>
            <span class="clearfix"></span>
          
            <span class="text-muted fs-13 ms-auto"><i class="mdi mdi-clock text-muted me-1"></i>{{ $list->created_at }}</span>
        </div>
        <div class="ms-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-end" role="menu">
                <li><a  href="{{ route('show_complaint',['complain_id'=>$list->id]) }}"><i class="feather feather-eye me-2"></i>View</a></li>
